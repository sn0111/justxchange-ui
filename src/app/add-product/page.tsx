    ...
    <div className="max-w-3xl md:mx-auto px-6 bg-white rounded-lg shadow-sm">
      ...
      <div className="mb-6">
        ...
        <div className="flex space-x-3">
          ...
          {['/path/to/image1.jpg', '/path/to/image2.jpg', '/path/to/image3.jpg', '/path/to/image4.jpg'].map((img, index) => (
            <div
              key={index}
      ...
      <div className="mb-6">
        ...
        <div className="grid grid-cols-2 gap-3">
          {[
            ...
            <label key={index} className="flex items-center p-3 border border-gray-300 rounded-lg cursor-pointer">
      ...
      <div className="mb-6">
        ...
        <div className="grid grid-cols-2 gap-3">
          {['New', 'Like New', 'Used', 'Heavily Used'].map((condition, index) => (
            <label key={index} className="flex items-center p-3 border border-gray-300 rounded-lg cursor-pointer">
      ...
      <div className="mb-6">
        <label className="block text-lg font-medium mb-2">Price or Exchange Terms</label>
