export default function Home(){
    return <>
      <div className="@container">
        <div className="p-4">
          <div
            ...
            style={{ backgroundImage: 'linear-gradient(rgba(0, 0, 0, 0.1) 0%, rgba(0, 0, 0, 0.4) 100%), url("https://cdn.usegalileo.ai/stability/22039637-33a8-415f-be27-ff86dc025603.png");' }}
          >
      ...
      <div className="flex gap-3 p-3 flex-wrap pr-4">
        {['Books', 'Shirts', 'Lab Equipment', 'Furniture', 'Art Supplies', 'More...'].map((item) => (
          <div key={item} className="flex h-8 shrink-0 items-center justify-center gap-x-2 rounded-xl bg-[#f0f2f5] pl-4 pr-4">
            <p className="text-[#111418] text-sm font-medium leading-normal">{item}</p>
          </div>
        ))}
      </div>
