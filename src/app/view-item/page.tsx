  ...
  return (
    ...
    >
      <div className="flex flex-col md:p-6">
        <div className=" gap-1 flex flex-1 flex-row justify-center ">
          <div className="relative flex h-1/2 grow bg-slate-50 @container p-4 md:flex layout-content-container flex-col w-60">
            <div
              className="w-full bg-center bg-no-repeat bg-cover aspect-[3/2] rounded-xl"
              style={{
            ...
            <button
              ...
              className="absolute left-2 top-1/2 -translate-y-1/2 bg-white rounded-full p-1 shadow-md hover:bg-gray-200"
            >
              <CaretLeft size={24} color="#0d141c" />
            </button>
            <button
              onClick={goToNext}
              className="absolute right-2 top-1/2 -translate-y-1/2 bg-white rounded-full p-1 shadow-md hover:bg-gray-200"
            >
              <RightIcon size={24} color="#0d141c" />
            </button>
          </div>
          <div className="layout-content-container flex flex-col w-[400px] flex-1">
            <p className="text-[#0d141c] text-base font-normal leading-normal pb-3 pt-2 px-4">
              Brand new, never used. Twin XL comforter, sheet set, and pillow case.
            </p>
            ...
            <div className="flex items-center gap-4 bg-slate-50 px-4 min-h-14 justify-between">
              <div className="flex items-center gap-4">
                <div
                  ...
                  style={{
                    backgroundImage: 'url("https://cdn.usegalileo.ai/stability/d7346a7c-e147-4fe0-a4d5-3a030d2d74bf.png");',
                  }}
                ></div>
        ...
        <div className="flex px-4 py-3 justify-end">
          ...
          <div className="px-3">
            <button className="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-xl h-10 px-4 bg-[#2589f4] text-white gap-2 pl-4 text-sm font-bold leading-normal tracking-[0.015em]">
