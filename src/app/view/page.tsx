...
export default function View() {
    ...
    return <div className="relative flex size-full min-h-screen flex-col bg-slate-50 group/design-root overflow-x-hidden">
        <h2 className="pl-6 text-[#0d141c] text-[22px] font-bold leading-tight tracking-[-0.015em]">Dorm Bedding Set</h2>
        <div className="flex flex-col md:flex-row w-full p-6">
            <div className="relative md:h-full w-[100%] md:w-2/3 bg-center bg-no-repeat bg-cover aspect-[3/2] rounded-xl" style={{
        ...
        <div className="flex px-4 py-3 justify-end">
          ...
          <div className="px-3">
            <Link href="/chat" className="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-xl h-10 px-4 bg-[#2589f4] text-white gap-2 pl-4 text-sm font-bold leading-normal tracking-[0.015em]">
